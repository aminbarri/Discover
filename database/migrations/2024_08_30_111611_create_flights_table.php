...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('plat', function (Blueprint $table) {
            ...
            $table->string('img1', 255)->nullable(); // Image 1 path with max length 255
            $table->string('img2', 255)->nullable(); // Image 2 path with max length 255
            $table->string('img3', 255)->nullable(); // Image 3 path with max length 255
