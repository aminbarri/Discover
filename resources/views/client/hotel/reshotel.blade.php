    ...
    <div class="container">
        ...
        <div id="reservation">
            ...
            <form action="{{ route('reservationh_store') }}" method="POST">
                ...
                <input type="number" class="form-control" id="nmbre_perssone" name="id_hotel" value="{{$hotel->id_hotel}}"
                    hidden>
                <div class="form-group">
                    <label for="nmbre_perssone">Number of Persons</label>
                    <input type="number" class="form-control" id="nmbre_perssone" name="nmbre_perssone"
                        value="{{ old('nmbre_perssone') }}" required>
                </div>
